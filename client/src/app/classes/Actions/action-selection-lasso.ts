...
export class ActionSelectionLasso extends Action {
    positionDepart: Vec2;
    positionFinal: Vec2;
    ...
    constructor(
        ...
        this.selectionLassoService = selectionLassoService;
    ...
    draw(): void {
        ...
        imageData = this.drawingService.makeInvisible(imageData, this.positionDepart, this.dimensionsDepart, this.pathData);
